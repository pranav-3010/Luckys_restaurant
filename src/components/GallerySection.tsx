...
export const GallerySection: React.FC = () => {
  ...
  return (
    <section id="gallery" className="py-24 relative bg-white border-t border-b border-[#D4AF37]/30">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all border ${
                activeFilter === tab.id
                  ...
                  : 'bg-[#FAF6F0] text-[#4A3E3E] border-gray-200 hover:text-[#E67E22]'
              }`}
            >
              {tab.label}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {filteredItems.map((item) => (
            <motion.div
              ...
              className="spice-card group relative rounded-3xl overflow-hidden cursor-pointer border border-gray-200 aspect-[4/3] bg-[#FAF6F0] shadow-sm hover:shadow-md"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1F1919]/90 via-[#1F1919]/40 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <div>
                  ...
                  <p className="text-xs text-[#E6DAD0] font-light mt-1">
                    {item.subtitle}
                  </p>
                </div>
                <div className="w-10 h-10 rounded-full bg-[#E67E22]/20 border border-[#E67E22]/40 flex items-center justify-center text-white ml-auto shrink-0 group-hover:scale-110 transition-transform">
      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-4xl w-full rounded-3xl overflow-hidden border border-[#E67E22] p-4 bg-white shadow-2xl">
            <img
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-xs text-[#6E5C5C] mt-1 font-light">

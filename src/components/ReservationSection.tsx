...
export const ReservationSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message =
`🍷 *TABLE RESERVATION REQUEST - Lucky's restaurant Suchitra*
--------------------------------------------------
👤 *Name:* ${formState.name}
          ...
          {submitted ? (
            <div className="p-8 bg-white border border-[#E6DBC5] text-center space-y-4">
              ...
              <p className="text-xs sm:text-sm text-[#6E5C5C] font-light">
                Our restaurant manager at Lucky's restaurant Suchitra will confirm your table shortly.
              </p>
              <button
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Arabian Mandi Special Seating Area">Arabian Mandi Special Seating Area</option>
                    <option value="Private Celebration Dining Space">Private Celebration Dining Space</option>
                  </select>
                  <ChevronDown className="w-4 h-4 text-gray-500 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" />
                </div>
              </div>
